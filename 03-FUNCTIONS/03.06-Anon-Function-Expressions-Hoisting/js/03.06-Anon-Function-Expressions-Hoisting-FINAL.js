...
btn3.addEventListener('click', function() {
    output3.textContent = "btn3 addEventListener('click', inline anonymous function)";
});
...
document.body.addEventListener('DOMContentLoaded', function(event) {
    output5.textContent = 'HOLA HOW ARE YOU??? BODY LOADED says inline anonymous function';
});
